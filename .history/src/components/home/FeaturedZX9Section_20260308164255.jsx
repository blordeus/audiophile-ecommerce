...
function FeaturedZX9Section() {
  ...
  return (
    <section className="mt-24 md:mt-32 lg:mt-40">
      <PageContainer>
        <div className="relative overflow-hidden rounded-lg bg-[#D87D4] px-6 pb-14 pt-14 text-center text-white md:px-14 md:pb-16 md:pt-16 lg:grid lg:min-h-[560px] lg:grid-cols-2 lg:items-end lg:px-24 lg:pb-0 lg:pt-0 lg:text-left">
          <img
            src={patternCircles}
            alt=""
            className="pointer-events-none absolute left-1/2 top-0 z-0 max-w-none -translate-x-1/2 md:top-[-120px] lg:left-0 lg:top-1/2 lg:-translate-y-1/2 lg:translate-x-[-35%]"
          />
